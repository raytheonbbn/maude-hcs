...
tne_output_dir=$scenario_dir/scenario2_7211_conf_combo2x5_64samples_formatted
raw_results_dir=$scenario_dir/scenario2_7211_conf_combo2x5_64samples_raw
...
python3 ./scripts/cp3_glue/format_for_tne_v2.py \
    ...
    --net-mapping "$scenario2_net_mapping" \
    --scenario "scenario2_7211_conf_combo2x5_64samples"
