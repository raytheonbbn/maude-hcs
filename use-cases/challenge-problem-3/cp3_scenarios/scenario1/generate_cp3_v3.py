...
def gen_addresses_file(hcs_nodes, tgen_instances, net_id_map):
    lines = []
    L = lines.append
...
def gen_main_file(tgen_instances, networks, loss_profiles, hcs_profiles_by_channel, duration, hcs_channel_models, hcs_client_ids):
    ...
    for i in [1, 2]:
        ...
        add_bidir_ixp(f"wtCl{i}ProxyAddr", "LinkType-ServerNet")
    link_entries.append("")
    ...
    for i in [5, 6]:
        ...
        add_bidir_ixp(f"obfsCl{i}ServerAddr", "LinkType-ServerNet")
    link_entries.append("")
    ...
    link_entries.append("    --- Skyhook server")
    ...
    dns_ixp_addrs = [
        "iodCl7SrvNetClAddr", "iodCl8SrvNetClAddr",
        "corpIodNetClAddr",
    ]
    ...
    add_bidir_ixp("publicDnsAddr", "LinkType-Dns")
    link_entries.append("")

    add_bidir_ixp("ircServerAddr", "LinkType-ServerNet")
    link_entries.append("")
...
if __name__ == "__main__":
    ...
    addr_content, hcs_client_ids = gen_addresses_file(hcs_nodes, tgen_instances, net_id_map)
    addr_path = os.path.join(OUT_DIR, "scenario1_addressesv3.maude")
